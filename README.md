...
Supporting material for some of the research works of Dr. Suzen. Including source code and 
dataset releases. Q&As are taken. Please open an issue or send Dr. Suzen an e-mail instead. 

* All supplements of research works are now using Zenodo:
Dr. Suzen's Zenodo repositories: [here](https://zenodo.org/search?q=metadata.creators.person_or_org.name%3A%22S%C3%BCzen%2C%20Mehmet%22&l=list&p=1&s=10&sort=bestmatch).
* Research works appear on Google Scholar: [here](https://scholar.google.de/citations?user=cUt21NIAAAAJ&hl=en)
